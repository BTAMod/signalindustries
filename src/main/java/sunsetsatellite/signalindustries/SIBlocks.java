...
public class SIBlocks extends DataInitializer {
    ...
    public void init() {
        ...
        basicCollector = new BlockBuilder(MOD_ID)
                .setHardness(1)
                .setResistance(3)
                .setBlockSound(BlockSounds.METAL)
                .setTextures("signalindustries:block/basic_blank")
                .setSideTextures("signalindustries:block/basic_collector_side_inactive")
                .setBlockModel((block) -> new BlockModelMachine(block, Tier.BASIC)
        ...
        reinforcedBuilder = new BlockBuilder(MOD_ID)
                .setHardness(1)
                .setResistance(3)
                .setBlockSound(BlockSounds.METAL)
                .setTextures("signalindustries:block/reinforced_blank")
                .setSouthTexture("signalindustries:block/reinforced_builder_front_inactive")
                .setBlockModel((block) -> new BlockModelMachine(block, Tier.REINFORCED)
