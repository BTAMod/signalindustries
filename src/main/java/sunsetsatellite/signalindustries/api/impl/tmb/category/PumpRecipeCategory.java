...
public class PumpRecipeCategory implements IRecipeCategory<FluidMachineRecipeTranslator> {
    ...
    public PumpRecipeCategory() {
        this.background = new DrawableBlank(120, 60);
        this.icon = new DrawableIngredient<>(SIBlocks.prototypePump.getDefaultStack(), ItemStackIngredientRenderer.INSTANCE);
