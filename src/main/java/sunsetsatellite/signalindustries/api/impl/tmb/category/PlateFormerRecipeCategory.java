...
public class PlateFormerRecipeCategory implements IRecipeCategory<MachineRecipeTranslator> {
    ...
    public PlateFormerRecipeCategory() {
        this.background = new DrawableBlank(120, 60);
        this.icon = new DrawableIngredient<>(SIBlocks.prototypePlateFormer.getDefaultStack(), ItemStackIngredientRenderer.INSTANCE);
