...
public class InfuserRecipeCategory implements IRecipeCategory<MachineRecipeTranslator> {
    ...
    public InfuserRecipeCategory() {
        ...
        this.icon = new DrawableIngredient<>(SIBlocks.basicInfuser.getDefaultStack(), ItemStackIngredientRenderer.INSTANCE);
