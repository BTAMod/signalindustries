...
public class WakingAlloySmelterRecipeCategory implements IRecipeCategory<MachineRecipeTranslator> {
    ...
    public WakingAlloySmelterRecipeCategory() {
        this.background = new DrawableBlank(120, 60);
        this.icon = new DrawableIngredient<>(SIBlocks.wakingAlloySmelter.getDefaultStack(), ItemStackIngredientRenderer.INSTANCE);
