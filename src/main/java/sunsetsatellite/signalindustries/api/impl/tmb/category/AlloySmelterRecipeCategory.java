...
public class AlloySmelterRecipeCategory implements IRecipeCategory<MachineRecipeTranslator> {
    ...
    public AlloySmelterRecipeCategory() {
        ...
        this.icon = new DrawableIngredient<>(SIBlocks.prototypeAlloySmelter.getDefaultStack(), ItemStackIngredientRenderer.INSTANCE);
