...
public class CrystalCutterRecipeCategory implements IRecipeCategory<MachineRecipeTranslator> {
    ...
    public CrystalCutterRecipeCategory() {
        this.background = new DrawableBlank(120, 60);
        this.icon = new DrawableIngredient<>(SIBlocks.prototypeCrystalCutter.getDefaultStack(), ItemStackIngredientRenderer.INSTANCE);
