...
public class WakingPlateFormerRecipeCategory implements IRecipeCategory<MachineRecipeTranslator> {
    ...
    public WakingPlateFormerRecipeCategory() {
        this.background = new DrawableBlank(120, 60);
        this.icon = new DrawableIngredient<>(SIBlocks.wakingPlateFormer.getDefaultStack(), ItemStackIngredientRenderer.INSTANCE);
