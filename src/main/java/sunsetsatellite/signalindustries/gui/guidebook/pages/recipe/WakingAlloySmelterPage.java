...
public class WakingAlloySmelterPage
    ...
    public WakingAlloySmelterPage(GuidebookSection section, ArrayList<RecipeEntryMachine> recipes) {
        super(section);
    ...
    protected void renderForeground(RenderEngine re, FontRenderer fr, int x, int y, int mouseX, int mouseY, float partialTicks) {
        drawStringCenteredNoShadow(fr, "Waking Alloy Smelter", x+width - 158 / 2, y+5, 0xFF808080);
        if(recipes.isEmpty()){
