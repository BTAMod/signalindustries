...
public class GuiStoneworks extends GuiFluid {

    public String name = "Stoneworks";
    public EntityPlayer entityplayer;
    public TileEntityStoneworks tile;


    public GuiStoneworks(InventoryPlayer inventoryPlayer, TileEntity tile) {
        super(new ContainerStoneworks(inventoryPlayer, (TileEntityFluidItemContainer) tile),inventoryPlayer);
        this.tile = (TileEntityStoneworks) tile;
    ...
    protected void buttonPressed(GuiButton guibutton) {
        ...
        switch (guibutton.id){
            ...
            case 2:
                ...
                guibutton.displayString = String.valueOf(tile.recipeId);
            default:
                break;
        }
    }
    ...
    public void init()
    {
        ...
        controlList.add(new GuiButton(2, Math.round(width / 2) + 60, Math.round(height / 2) - 30, 20, 20, String.valueOf(tile.recipeId)));
        super.init();
    }
}
